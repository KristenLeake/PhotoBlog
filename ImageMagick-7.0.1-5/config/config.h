...
#define LIBRARY_PATH "/usr/local/lib/ImageMagick-7.0.1/"

/* Subdirectory of lib where ImageMagick architecture dependent files are
   installed. */
#define LIBRARY_RELATIVE_PATH "ImageMagick-7.0.1"
...
/* Target Host OS */
#define MAGICK_TARGET_OS darwin15.4.0
...
#define PACKAGE_STRING "ImageMagick 7.0.1-5"
...
#define PACKAGE_VERSION "7.0.1-5"
